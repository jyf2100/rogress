      ...
      <div className="py-4">
        ...
        >
          <Space direction="vertical" className="w-full">
            ...
            <Radio value="APISIX" className="w-full p-3 border rounded-lg hover:bg-gray-50">
              <div className="ml-2">
                <div className="font-medium">{GATEWAY_TYPE_LABELS.APISIX}</div>
                <div className="text-sm text-gray-500">Apache APISIX 云原生网关</div>
              </div>
            </Radio>
          </Space>
        </Radio.Group>
